...
## [0.1.0] - 2025-07-28
- Upstream release by [@arazgholami](https://github.com/arazgholami) — this is the original project that was forked as the base for M3U Editor Pro; basic M3U editor with group list, channel list, drag-and-drop reorder, item edit form, and download; sort did not work on large files and loading large playlists would freeze the browser
